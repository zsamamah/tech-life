...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Bootstrap template for you store - E-Commerce Bootstrap Template"
    />
    <meta
      name="keywords"
    ...
    <header>
      <div class="carousel" data-count="3" data-current="2">
                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-sm-8 col-sm-offset-2 align-center">
                        <img
                          style="height: 20em"
                          src="assets/img/carousel/bbb.png"
                          alt="Surface Pro"
                        />
                      </div>
                      <div class="col-sm-12 align-center">
                        ...
                        <p>
                          The laptop comes with an Intel i5 chip and 8GB of RAM.
                        </p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4 align-left">
                        ...
                        <p>
                          ...
                          Apple plans to stay ahead in mobile. When it comes to
                          the brand’s latest iPhones, the biggest excitement
                          isn’t focused on the addition of a rose gold coloured
                          device but the new 3D touch sensors.
                        </p>
        ...
        <ul class="markers">
          <li data-marker="1">
            <img
              src="assets/img/carousel/Webp.net-resizeimage.png"
              alt="Background"
            />
          </li>
          <li data-marker="2" class="active">
            <img src="assets/img/carousel/bbb.png" alt="Background" />
          </li>
          <li data-marker="3">
            <img src="assets/img/carousel/c.png" alt="Background" />
          </li>
        </ul>
      </div>
    </header>
...
$db->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
      ...
      as $element){ echo "
        ...
        <a href='./blog/'>
            <img src='$element[image]' alt='product Image' class='image'/>
        </a>
          <br><br>
          ...
          <div class="col-sm-3 col-md-2">
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li>
                  <a href="#English">
                    <img src="assets/img/flags/gb.png" alt="Eng" /> English</a
                  >
                </li>
                <li>
                  <a href="#Spanish">
                    <img src="assets/img/flags/es.png" alt="Spa" /> Spanish</a
                  >
                </li>
                <li>
                  <a href="#Deutch">
